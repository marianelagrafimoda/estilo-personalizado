      ...
      <div className="container mx-auto px-4 py-8 flex-grow">
        ...
        <Tabs defaultValue="products">
          ...
          <TabsContent value="site" className="space-y-6 animate-fade-in">
            <Card className="shadow-md border-lilac/20">
              <CardHeader>
                <CardTitle className="font-serif">Información del Sitio</CardTitle>
                <CardDescription>
                  Actualice la información básica del sitio
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      className="border-lilac/30 focus:border-lilac focus:ring-lilac"
                      placeholder="https://www.instagram.com/su-cuenta"
                    />
                  </div>
                  <div className="space-y-2">
                    <label className="text-sm font-medium flex items-center">
                    ...
                    <Input
                      ...
                      className="border-lilac/30 focus:border-lilac focus:ring-lilac"
                      placeholder="https://www.facebook.com/su-pagina"
                    />
                  </div>
                </div>

                <div className="space-y-2">
                  <label className="text-sm font-medium">Título de "Estilo Único"</label>
                  <Input
                ...
                <div className="pt-4 border-t border-gray-100">
                  <h3 className="text-md font-medium mb-2">Sección "Por qué elegirnos"</h3>
                  
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="space-y-2">
                      <label className="text-xs font-medium">Título Materiales</label>
                      <Input
                        value={newMaterialsTitle}
                        onChange={(e) => setNewMaterialsTitle(e.target.value)}
                        className="border-lilac/30 focus:border-lilac focus:ring-lilac text-sm"
                      />
                    ...
                    <div className="space-y-2">
                      <label className="text-xs font-medium">Título Diseño</label>
                      <Input
                    ...
                    <div className="space-y-2">
                      <label className="text-xs font-medium">Título Servicio</label>
                      <Input
                ...
                <div className="pt-4 border-t border-gray-100">
                  <h3 className="text-md font-medium mb-2">Sección "Nuestros Productos"</h3>
                  <div className="space-y-2">
                ...
                <div className="space-y-2">
                  <label className="text-sm font-medium">Título de FAQs</label>
                  <Input
                    value={newFaqTitle}
          ...
          <TabsContent value="carousel" className="space-y-6 animate-fade-in">
            <Card className="shadow-md border-lilac/20">
              <CardHeader>
                <CardTitle className="font-serif">Carrusel</CardTitle>
                <CardDescription>
              ...
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  <label className="text-sm font-medium">Imágenes del Carrusel</label>
                  <div className="mt-2">
                    <ProductImagesUploader 
          ...
          <TabsContent value="footer" className="space-y-6 animate-fade-in">
            <Card className="shadow-md border-lilac/20">
              <CardHeader>
                <CardTitle className="font-serif">Pie de Página</CardTitle>
                <CardDescription>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  <label className="text-sm font-medium">Título de Enlaces Rápidos</label>
                  <Input
                ...
                <div className="space-y-2">
                  <label className="text-sm font-medium">Enlaces Personalizados</label>
                  <div className="mt-2">
                    <div className="flex flex-wrap gap-2">
                      {footerCustomLinks.map((link, index) => (
                        <div key={index} className="flex items-center gap-2 bg-gray-100 p-1 pr-2 rounded">
